		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<?php if($options['banner_title']) { ?>
						<h1 class="mb-3 mt-3"><?php echo $options['banner_title'];?></h1>
					<?php } ?>

					<?php if($options['banner_description']) { ?>
						<p class="mb-4 pr-5"><?php echo $options['banner_description'];?></p>
					<?php } ?>

					<?php if($options['banner_button']['text']){?>
						<div class="btn-container ">
							<a href="<?php echo $options['banner_button']['url'];?>" target="_blank" class="btn btn-main-2 btn-icon btn-round-full"><?php echo $options['banner_button']['text'];?> <i class="<?php echo $options['banner_btn_icon'];?> ml-2  "></i></a>
						</div>
					<?php } ?>					
